...
export const CLAUDE_SIGNAL_DEFINITIONS: readonly TranscriptSignalDefinition[] = [
  ...
  {
    provider: "claude",
    key: "claude.progress.bash",
    group: "tooling",
    phase: "tooling",
    pattern: "type == 'progress' && data.type == 'bash_progress'",
    description: "Claude emitted shell-command progress output.",
    confidence: "high",
    driftRisk: "medium",
  },
  {
  ...
  },
  {
    ...
    group: "lifecycle",
    phase: "thinking",
    pattern: "subtype == 'compact_boundary' || type/subtype == 'CompactBoundaryMessage'",
    description: "Claude compacted conversation context.",
    confidence: "high",
    driftRisk: "medium",
  },
  {
...
export const CODEX_SIGNAL_DEFINITIONS: readonly TranscriptSignalDefinition[] = [
  ...
  {
    provider: "codex",
    key: "codex.response.custom_tool_call",
    group: "tooling",
    phase: "tooling",
    pattern: "type == 'response_item' && payload.type == 'custom_tool_call'",
    description: "Codex requested a custom tool call.",
    confidence: "high",
    driftRisk: "medium",
  },
  {
    provider: "codex",
    key: "codex.response.custom_tool_call_output",
    group: "tooling",
    phase: "tooling",
    pattern: "type == 'response_item' && payload.type == 'custom_tool_call_output'",
    description: "Codex received custom tool output.",
    confidence: "high",
    driftRisk: "medium",
  },
  {
  ...
  {
    provider: "codex",
    key: "codex.event.agent_reasoning",
    group: "thinking",
    phase: "thinking",
    pattern: "type == 'event_msg' && payload.type == 'agent_reasoning'",
    description: "Codex emitted thinking/reasoning progress text.",
    confidence: "medium",
    driftRisk: "medium",
  },
  {
  ...
  {
    provider: "codex",
    key: "codex.event.task_started",
    group: "turn",
    phase: "thinking",
    pattern: "type == 'event_msg' && payload.type == 'task_started'",
    description: "Codex task lifecycle started.",
    confidence: "high",
    driftRisk: "low",
  },
  {
    provider: "codex",
    key: "codex.event.task_complete",
    group: "lifecycle",
    phase: "waiting",
    pattern: "type == 'event_msg' && payload.type == 'task_complete'",
    description: "Codex task lifecycle completed.",
    confidence: "high",
    driftRisk: "low",
  },
  {
    provider: "codex",
    key: "codex.event.turn_aborted",
    group: "lifecycle",
    phase: "waiting",
    pattern: "type == 'event_msg' && payload.type == 'turn_aborted'",
    description: "Codex turn was aborted/interrupted.",
    confidence: "high",
    driftRisk: "medium",
  },
  {
